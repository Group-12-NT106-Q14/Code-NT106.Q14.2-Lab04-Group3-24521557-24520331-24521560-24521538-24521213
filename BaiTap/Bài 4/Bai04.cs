    ...
    public partial class Bai04 : Form
    {
        ...
        private async Task<List<MovieSummary>> CrawlMoviesAsync()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // Các khối film-info chứa thông tin phim đang chiếu
                ...
                foreach (var filmInfo in filmInfoNodes)
                {
                    ...
                    // Poster: img.border-radius-20 nằm trong khối product-item phía trước
                    var productItem = filmInfo.ParentNode; // col-lg-16 ...
                    if (productItem != null)
                        productItem = productItem.ParentNode; // row -> chứa product-item
                    ...
                    // Nếu có query string gf=... thì tách để lưu Id
                    string id = null;
                    ...
                    await Task.Delay(50); // cho progressBar chạy mượt hơn
                }
            }
        ...
        private Panel CreateMovieItemPanel(MovieSummary movie)
        {
            ...
            // Gắn event click cho cả panel và child
